...
//  !! Diğer paketlerde kullanılabilirlik için metod ve alan isimlendirmeleri büyük harfle başlamalı !!
...
func Mapler() {
	...
	fmt.Println(phoneBooks[21312313])
	phoneBooks[32131231] = "Akif"
...
// Return kullanımı
func AlanHesapla(r float32) float32 {
	return 3.14 * r * r
}
